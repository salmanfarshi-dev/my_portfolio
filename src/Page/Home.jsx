    ...
    <Element name="home">
      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="">
            <h1 className="tittle ">
              <span className="text-white text-[45px] md:text-[55px]">
                Hello, I'm{" "}
              </span>
              Salman Farshi
            </h1>
            <p className="text-text-secondary text-[16px] md:text-[18px] font-normal w-full md:w-[65%] md:mt-5 mt-3 ">
              ...
              applications. Passionate about clean code and intuitive
              interfaces, I’m currently expanding my expertise in the MERN
              Stack.
            </p>
